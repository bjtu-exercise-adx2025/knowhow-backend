...
- summary: 文章核心内容摘要（20-60字），不要超过60字
...
请始终返回有效的JSON数组格式。"""
    ...
    def format_analysis_prompt(
        self, new_text: str, existing_articles: List[Dict[str, Any]]
    ) -> str:
        """
        格式化分析prompt
        ...
        return self.ANALYSIS_PROMPT_TEMPLATE.format(
            new_text=new_text.strip(), formatted_articles=formatted_articles
        )
